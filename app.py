...
def download_report():
    ...
    output_file = f"/tmp/attendance_report_{filter_type}.xlsx"
    df.to_excel(output_file, index=False)
    
    from flask import send_file
    return send_file(output_file, as_attachment=True, download_name=f"attendance_report_{filter_type}.xlsx")
