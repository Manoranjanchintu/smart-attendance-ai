...
def download_report():
    ...
    return send_file(
        output,
        as_attachment=True,
        download_name=f"attendance_report_{filter_type}.xlsx",
...
# Initialize DB at module level so this runs under both Gunicorn (Render)
# and direct `python app.py`. The 'if __name__' block is NOT executed by Gunicorn.
